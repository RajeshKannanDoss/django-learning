...
class MatchCreateTestCase(TestCase):
    ...
    def setUp(self):
        league = League.objects.create(name='TESTCASELEAGUE', shortcut='testcaseleague')
        team1 = Team.objects.create(name='TESTCASETEAM1', shortcut='testcaseteam1')
        team2 = Team.objects.create(name='TESTCASETEAM2', shortcut='testcaseteam2')
    ...
    def test_team_home_win_statistic(self):
        ...
        :return:
        """
        Match.objects.create(team_home=self.team_stat1, team_guest=self.team_stat2,
                             team_home_goals=2, team_guest_goals=1)
    ...
    def test_team_home_lose_statistic(self):
        ...
        """
        Match.objects.create(team_home=self.team_stat1, team_guest=self.team_stat2,
                             team_home_goals=1, team_guest_goals=2)
    ...
    def test_team_draw_statistic(self):
        """
        Test when home team and guest team have equal count of goals (example 1:1)
        :return:
        """
        Match.objects.create(team_home=self.team_stat1, team_guest=self.team_stat2,
                             team_home_goals=1, team_guest_goals=1)
